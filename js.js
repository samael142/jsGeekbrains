...
const game = {
    count: 0, // Добавил
    counterField: document.getElementById('counter'), // Добавил
    config,
    map,
    snake,
    food,
    ...
    reset() {
        ...
        this.barrier.setCoordinates(this.getRandomFreeCoordinates()); // Добавил
        this.render();
    },
    // Добавил тут
    render() {
    ...
    tickHandler() {
        ...
        if (this.barrier.isOnPoint(this.snake.getNextStepHeadPoint())) this.finish();
        ...
        if (this.food.isOnPoint(this.snake.getNextStepHeadPoint())) {
            ...
            this.count++
            this.drowCounter(this.count) //Добавил
    ...
    finish() {
        ...
        alert(`Игра окончена со счётом ${this.count}`)
        this.count = 0; // Добавил
        this.drowCounter(this.count) // Добавил
    },
    ...
    // Добавил
    drowCounter(counter) {
        this.counterField.textContent = counter;
    },
};
